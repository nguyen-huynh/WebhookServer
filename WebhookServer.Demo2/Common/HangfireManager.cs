...
namespace WebhookServer.Demo2.Common
{
    public class HangfireManager : IDisposable
    {
        ...
        public HangfireManager(ILogger<HangfireManager> logger, CacheManager cache, IServiceProvider serviceProvider)
        {
            this._logger = logger;
            this._cache = cache;
        ...
        public void Configure()
        {
            ...
            _logger.LogInformation("Hangfire Dashboard run at: http://localhost:5000/hangfire");
